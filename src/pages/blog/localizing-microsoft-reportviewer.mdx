...
excerpt: How to localize the Microsoft ReportViewer Control in Dutch (or any language) by implementing the three IReportViewerMessages interfaces
lang: en
date: "2012-05-05"
thumb: /assets/05-05-2012-dutch-reportviewer.png
tags:
 - How-to
 - .NET
---
...
```csharp title=DutchReportViewerMessages.cs
using System;
...
```csharp title=DutchReportViewerMessagesTests.cs
using System;
