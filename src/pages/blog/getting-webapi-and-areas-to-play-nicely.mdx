...
excerpt: How to make WebApi Routes Area-aware
lang: en
date: "2012-08-15"
thumb: /assets/2012-08-15-asp-net-mvc-webapi-areas.png
tags:
 - How-to
 - .NET
---
...
```csharp title=AreaRegistration.cs
...
```csharp title=AdministrationAreaRegistration.cs
...
```csharp title=AreaRegistrationContextExtensions.cs
...
```csharp title=AreaHttpControllerSelector.cs
