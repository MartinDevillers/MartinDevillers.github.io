---
layout: post
title: Debugging production with hidden modals
comments: true
permalink: blog/debugging-production-with-hidden-modals/
excerpt: How to change the behavior of an application using a (hidden) settings screen
lang: en
date: "2020-05-12"
thumb: /assets/2020-05-12-splash.jpg
tags:
 - How-to
 - React
 - TypeScript
...
![...](/assets/2020-05-12-giphy-tumbleweed.gif)
...
If you think this is just some crazy feature I've implemented in my own pet-project, think again because I've been building these hidden debug tools into most of my former client's applications (and yes with their consent). Why? Because I'm a huge fan of *Testing In Production* (yay) and not-such-a-big-fan of *But It Worked On Develop/Test/Acceptance/Demo/RC/Spike/Bla* (boo).
 ...
 ![Stats for nerds](/assets/2020-05-12-youtube-stats-for-nerds.png)
...
```typescript title=src/settings.ts
